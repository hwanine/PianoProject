...
class Frame extends JFrame
{
	...
	public Frame()
	{
		...
		help_button.setBounds(1170, 140, 100, 100);
		panel.add(help_button);
		
		JTextField octave = new JTextField("2옥타브 ~ 3옥타브");
		...
		{	
			...
			{	
				...
				{
					Low low_octave = new Low();
					low_octave.setVisible(true);
				}
			}
		});
		...
		{	
			...
			{	
				...
				{
					High high_octave = new High();
					high_octave.setVisible(true);
				}
			}
		});
		...
		{	
			...
			case 6:
			{
				...
				black_keyboard.setBackground(Color.black);
				panel.add(black_keyboard);
				insertSound(black_keyboard, "sounds\\piano_35_110_61.wav");
				inputKey(black_keyboard, '2', "sounds\\piano_35_110_61.wav");
			...
			case 7:
			{
				...
				black_keyboard.setBackground(Color.black);
				panel.add(black_keyboard);
				insertSound(black_keyboard, "sounds\\piano_35_110_63.wav");
				inputKey(black_keyboard, '3', "sounds\\piano_35_110_63.wav");
			...
			case 8:
			{
				...
				black_keyboard.setBackground(Color.black);
				panel.add(black_keyboard);
				insertSound(black_keyboard, "sounds\\piano_35_110_66.wav");
				inputKey(black_keyboard, '5', "sounds\\piano_35_110_66.wav");
			...
			case 9:
			{
				...
				black_keyboard.setBackground(Color.black);
				panel.add(black_keyboard);
				insertSound(black_keyboard, "sounds\\piano_35_110_68.wav");
				inputKey(black_keyboard, '6', "sounds\\piano_35_110_68.wav");
			...
			case 10:
			{
				...
				black_keyboard.setBackground(Color.black);
				panel.add(black_keyboard);
				insertSound(black_keyboard, "sounds\\piano_35_110_70.wav");
				inputKey(black_keyboard, '7', "sounds\\piano_35_110_70.wav");
			}
			}
	    ...
	    while(i <= 14)
	    {
	    	...
	    	case 1:
	    	{
				...
				inputKey(white_keyboard, 'z', "sounds\\piano_35_110_48.wav");
	    	}
	    	case 2:
	    	{
	    		final JButton white_keyboard = new JButton();
	    	...
	    	case 8:
	    	{
				...
				white_keyboard.setBackground(Color.white);
				panel.add(white_keyboard);
				insertSound(white_keyboard, "sounds\\piano_35_110_60.wav");
				inputKey(white_keyboard, 'q', "sounds\\piano_35_110_60.wav");
	    	}
	    	case 9:
	    	{
	    		final JButton white_keyboard = new JButton();
				...
				white_keyboard.setBackground(Color.white);
				panel.add(white_keyboard);
				insertSound(white_keyboard, "sounds\\piano_35_110_62.wav");
				inputKey(white_keyboard, 'w', "sounds\\piano_35_110_62.wav");
	    	}
	    	case 10:
	    	{
	    		final JButton white_keyboard = new JButton();
				...
				white_keyboard.setBackground(Color.white);
				panel.add(white_keyboard);
				insertSound(white_keyboard, "sounds\\piano_35_110_64.wav");
				inputKey(white_keyboard, 'e', "sounds\\piano_35_110_64.wav");
	    	}
	    	case 11:
	    	{
	    		final JButton white_keyboard = new JButton();
				...
				white_keyboard.setBackground(Color.white);
				panel.add(white_keyboard);
				insertSound(white_keyboard, "sounds\\piano_35_110_65.wav");
				inputKey(white_keyboard, 'r', "sounds\\piano_35_110_65.wav");
	    	}
	    	case 12:
	    	{
	    		final JButton white_keyboard = new JButton();
				...
				white_keyboard.setBackground(Color.white);
				panel.add(white_keyboard);
				insertSound(white_keyboard, "sounds\\piano_35_110_67.wav");
				inputKey(white_keyboard, 't', "sounds\\piano_35_110_67.wav");
	    	}
	    	case 13:
	    	{
	    		final JButton white_keyboard = new JButton();
				...
				white_keyboard.setBackground(Color.white);
				panel.add(white_keyboard);
				insertSound(white_keyboard, "sounds\\piano_35_110_69.wav");
				inputKey(white_keyboard, 'y', "sounds\\piano_35_110_69.wav");
	    	}
	    	case 14:
	    	{
	    		final JButton white_keyboard = new JButton();
				...
				white_keyboard.setBackground(Color.white);
				panel.add(white_keyboard);
				insertSound(white_keyboard, "sounds\\piano_35_110_71.wav");
				inputKey(white_keyboard, 'u', "sounds\\piano_35_110_71.wav");
	    	}
	    	}
